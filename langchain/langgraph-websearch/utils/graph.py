...
# retrieve로 조회한 문서들이 사용자 질문과 연관이 있는지 확인
...
# 조회한 문서(RAG or Websearch)를 기반으로 LLM 답변 생성
def generate(state):
    """
    Generate answer
